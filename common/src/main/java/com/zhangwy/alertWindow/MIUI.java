...
public class MIUI {
    ...
    private static void reqForMiui67(Context context) {
        ...
        final String pkgName = "com.miui.securitycenter";
        final String className = "com.miui.permcenter.permissions.AppPermissionsEditorActivity";
    ...
    private static void reqForMiui89(Context context) {
        final String action = "miui.intent.action.APP_PERM_EDITOR";
        final String pkgName = "com.miui.securitycenter";
        final String className = "com.miui.permcenter.permissions.PermissionsEditorActivity";
        Intent intent = new Intent(action);
        intent.setClassName(pkgName, className);
        intent.putExtra("extra_pkgname", context.getPackageName());
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
