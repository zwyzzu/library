...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth =  DEFAULT_BORDER_WIDTH * density;
        mColors = new int[4];
        mColors[0] = Color.RED;
        mColors[1] = Color.YELLOW;
        mColors[2] = Color.GREEN;
        mColors[3] = Color.BLUE;
    ...
    private static int gradient(int color1, int color2, float p) {
        ...
        int b2 = color2 & 0xff;
        return Color.argb(255, (int) (r2 * p + r1 * (1 - p)), (int) (g2 * p + g1 * (1 - p)), (int) (b2 * p + b1 * (1 - p)));
    }
